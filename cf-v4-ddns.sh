...
declare -A RECORDS
RECORDS["target1.example.com"]="source1.example.com"
RECORDS["target2.example.com"]="source2.example.com"
# RECORDS["target.example.com"]="source3.example.com"
...
# muti update
for CFRECORD_NAME in "${!RECORDS[@]}"; do
  WANIPSITE=${RECORDS[$CFRECORD_NAME]}
  echo "Processing record: $CFRECORD_NAME"
  echo "WAN IP Site: $WANIPSITE"
